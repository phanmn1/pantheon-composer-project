...
class LampreyFormQA extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      $form['#attached']['drupalSettings']['username'] = $this->GetCurrentUser(); 
      $form['#attached']['drupalSettings']['baseUrl'] =  \Drupal::config('apiurl')->get('value'); 
      $form['#attached']['library'][] = 'quality_assurance/lampreyQA';
      $form['#attached']['library'][] = 'quality_assurance/datatables_library';
      
      $form['title'] =[
          '#markup' => '<h1>Lamprey Data QA Form</h1>'                                          
        ];
